import { StyleSheet, Text, View, ScrollView, TouchableOpacity, TextInput, Modal, KeyboardAvoidingView, Platform, Linking, Share, Image } from 'react-native';
...
const SHOPS = {
  "San Francisco": {
    ...
    shops: [
      {
        name: "Linea Caffe", hood: "Mission District", rating: 4.9,
        tags: ["Best Latte", "Traditional", "Cappuccino"],
        hours: "Mon–Fri 7am–3pm, Wknd 8am–3pm", price: "$$", wifi: "Limited", seats: "Cozy", openNow: true, stamps: 847, isHiddenGem: false,
        photo: "https://lineacaffe.com/wp-content/uploads/2021/06/linea-outdoor-line.jpg",
        desc: "Widely considered SF's finest espresso bar — a tiny, precise Mission space where some of the most technically perfect shots in the country are pulled.",
        reviews: [{ a: "Local coffee writer", t: "The best straight espresso in San Francisco. No shortcuts, no gimmicks." }, { a: "Verified visitor", t: "Flew in from Chicago and made this my first stop. Worth every minute." }]
      },
      {
        name: "Sightglass Coffee", hood: "SoMa", rating: 4.8,
        tags: ["Ambiance", "Work Spot", "Best Latte"],
        hours: "Mon–Fri 7am–5pm, Wknd 8am–5pm", price: "$$", wifi: "Yes", seats: "Plenty", openNow: true, stamps: 912, isHiddenGem: false,
        photo: "https://img1.10bestmedia.com/Images/Photos/416582/Sightglass-Coffee_54_990x660.jpg",
        desc: "An iconic two-story SoMa roastery with soaring ceilings and massive skylights. The most beautiful café interior in San Francisco.",
        reviews: [{ a: "Eater SF", t: "The room is as good as the coffee. A genuine SF landmark." }, { a: "Visitor", t: "Nothing in the city comes close to the atmosphere here." }]
      },
      {
        name: "Ballast Coffee", hood: "West Portal", rating: 4.7,
        tags: ["Experience", "Ambiance", "Work Spot"],
        hours: "Mon–Fri 7:30am–8pm, Wknd 7:30am–5pm", price: "$$", wifi: "Yes", seats: "Plenty", openNow: false, stamps: 234, isHiddenGem: true,
        photo: "https://s3-media0.fl.yelpcdn.com/bphoto/I0-r3ff9BnkSrJEAYz857w/348s.jpg",
        desc: "SF's only source of Philippine Barako coffee — imported directly from Lipa, Batangas. The ube latte is stunning.",
        reviews: [{ a: "Nextdoor neighbor", t: "The Barako bean is a must try. You cannot find it elsewhere in SF." }, { a: "Regular", t: "The ube latte is beautiful. Big space, lovely patio, great wifi." }]
      },
      {
        name: "Paper Son Coffee", hood: "Dogpatch", rating: 4.8,
        tags: ["Experience", "Best Latte", "Matcha"],
        hours: "Tue–Sun 8am–4pm", price: "$$", wifi: "Yes", seats: "Moderate", openNow: true, stamps: 445, isHiddenGem: true,
        photo: "https://res.cloudinary.com/the-infatuation/image/upload/v1662504222/images/VerveCoffee_MarketStreet_PressPhoto_urocsl.jpg",
        desc: "A love letter to the Asian-American coffee experience. Pandan aerocanos, cardamom cappuccinos, exceptional matcha.",
        reviews: [{ a: "SF Magazine", t: "The most creative menu in SF specialty coffee." }, { a: "Regular", t: "The pandan aerocano changed my life." }]
      },
      {
        name: "Andytown Coffee", hood: "Outer Sunset", rating: 4.7,
        tags: ["Traditional", "Date Spot", "Ambiance"],
        hours: "Mon–Sun 7am–5pm", price: "$", wifi: "No", seats: "Cozy", openNow: true, stamps: 389, isHiddenGem: false,
        photo: "https://live.staticflickr.com/3871/15110445001_2986b3b0f5_b.jpg",
        desc: "A beloved institution at the foggy edge of the city, roasting on-site since 2014. Warm wood interior, community feel.",
        reviews: [{ a: "SF Gate", t: "The soul of the Outer Sunset in café form." }, { a: "Regular", t: "This is what a neighborhood coffee shop is supposed to feel like." }]
      },
      {
        name: "Saint Frank Coffee", hood: "Russian Hill", rating: 4.7,
        tags: ["Best Latte", "Date Spot", "Cappuccino"],
        hours: "Mon–Fri 7am–5pm, Wknd 8am–5pm", price: "$$", wifi: "Limited", seats: "Cozy", openNow: false, stamps: 312, isHiddenGem: false,
        photo: "https://openscopestudio.com/wp-content/uploads/2020/10/St-Frank-Coffee-0124-3069902204-O-e1603836207979.jpg",
        desc: "A refined Russian Hill gem with exceptional single-origin focus. SF's best kept secret for a coffee date.",
        reviews: [{ a: "Yelp Top Reviewer", t: "By far the best coffee in San Francisco." }, { a: "Regular", t: "My go-to date spot. Quiet, warm, genuinely special." }]
      },
      {
        name: "Tadaima", hood: "Mission District", rating: 4.8,
        tags: ["Matcha", "Experience", "Date Spot"],
        hours: "Mon–Thu 11am–4:30pm, Fri–Sun 10am–5:30pm", price: "$", wifi: "Limited", seats: "Cozy", openNow: true, isNew: true, stamps: 567, isHiddenGem: false,
        photo: "https://assets.sfstandard.com/image/994911177489/image_1pls21bugl29790qa3dnl5d44o",
        desc: "The Mission's most exciting matcha spot since 2024. Japanese comfort food meets exceptional ceremonial matcha — the matcha latte with salted cream cheese is the best in SF.",
        reviews: [{ a: "TikTok visitor", t: "The matcha latte with salted cream cheese is probably the best matcha latte I've had in the city." }, { a: "SF food writer", t: "Tadaima means 'I'm home' in Japanese. That warmth comes through in every bite and sip." }]
      },
      {
        name: "Q Specialty Coffee", hood: "Laurel Heights", rating: 4.8,
        tags: ["Matcha", "Experience", "Best Latte"],
        hours: "Daily — check Instagram for hours", price: "$$", wifi: "Yes", seats: "Moderate", openNow: true, isNew: true, stamps: 734, isHiddenGem: false,
        photo: "https://res.cloudinary.com/the-infatuation/image/upload/q_auto,f_auto/Untitled_design_17_d6hh9s",
        desc: "SF's most viral new café — and the hype is earned. Owner Cyrus Shen roasts green beans in-house in just 12 minutes. Six matcha drinks including the Triple Matcha Yuzu Cloud. Lines out the door daily.",
        reviews: [{ a: "Axios SF, 2026", t: "After one sip, it all made sense. The matcha is forever my favorite." }, { a: "Yelp reviewer", t: "Best matcha in San Fran. Newly opened. The presentation is amazing." }]
      },
    ]
  },
  "Los Angeles": {
    ...
    shops: [
      {
        name: "Harun Coffee", hood: "Leimert Park", rating: 4.8,
        tags: ["Experience", "Ambiance", "Cold Brew"],
        hours: "Mon–Sun 7am–4pm & 6pm–11pm", price: "$$", wifi: "Yes", seats: "Plenty", openNow: true, isCultural: true, stamps: 1243, isHiddenGem: false,
        photo: "https://res.cloudinary.com/the-infatuation/image/upload/c_fill,w_1400,ar_4:3,g_center,f_auto/cms/guides/5-exciting-things-to-do-eat-between-august-18th-22nd/Harun_Coffee",
        desc: "A cultural institution in Leimert Park. By day a specialty coffee shop; by night a speakeasy through a hidden wall. Founded by A$AP Rocky's former manager.",
        reviews: [{ a: "The Infatuation", t: "More than coffee — a community hub with a gallery and lifestyle brand." }, { a: "LA Sentinel, 2026", t: "Pull open the canary yellow wall and enter a high-ceilinged speakeasy." }]
      },
      {
        name: "Go Get Em Tiger", hood: "Los Feliz", rating: 4.9,
        tags: ["Best Latte", "Work Spot", "Experience"],
        hours: "Mon–Fri 7am–5pm, Wknd 8am–5pm", price: "$$", wifi: "Yes", seats: "Plenty", openNow: true, stamps: 987, isHiddenGem: false,
        photo: "https://gget.com/cdn/shop/files/GCM_cafe.jpg?v=1732579503&width=2400",
        desc: "Founded by two James Beard award winners, GGET redefined LA specialty coffee with a cocktail bar service model.",
        reviews: [{ a: "LA Times", t: "GGET changed how LA thinks about the entire coffee experience." }, { a: "Regular", t: "The macchiato flight alone is worth the trip." }]
      },
      {
        name: "Verve Coffee Roasters", hood: "Downtown LA", rating: 4.8,
        tags: ["Work Spot", "Ambiance", "Best Latte"],
        hours: "Mon–Fri 7am–6pm, Wknd 8am–6pm", price: "$$", wifi: "Excellent", seats: "Plenty", openNow: true, stamps: 756, isHiddenGem: false,
        photo: "https://www.vervecoffee.com/cdn/shop/files/Cafes-SpringSt-9018_800x.jpg?v=1654116154",
        desc: "The Santa Cruz roaster's DTLA flagship — soaring ceilings, living plant walls, light that makes you want to stay all day.",
        reviews: [{ a: "Coffee Traveler", t: "High ceilings, concrete, living plants. A perfect work environment." }, { a: "Regular", t: "The oat cortado is smooth perfection." }]
      },
      {
        name: "Maru Coffee", hood: "Arts District", rating: 4.8,
        tags: ["Traditional", "Cappuccino", "Matcha"],
        hours: "Daily 7am–5pm", price: "$$", wifi: "Limited", seats: "Moderate", openNow: true, stamps: 645, isHiddenGem: false,
        photo: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0f/29/11/42/photo0jpg.jpg?w=500&h=-1&s=1",
        desc: "Named for the Korean word for mountaintop. Japanese-influenced precision. The cappuccino and matcha are world class.",
        reviews: [{ a: "Timeout LA", t: "Lines down the block on weekends. The best cappuccino in Los Angeles." }, { a: "Regular", t: "Every detail is considered — the cup, the pour, the space." }]
      },
      {
        name: "Intelligentsia Coffee", hood: "Silver Lake", rating: 4.7,
        tags: ["Traditional", "Work Spot", "Cold Brew"],
        hours: "Mon–Fri 6am–7pm, Wknd 7am–7pm", price: "$$", wifi: "Yes", seats: "Plenty", openNow: false, stamps: 534, isHiddenGem: false,
        photo: "https://images.squarespace-cdn.com/content/v1/5ecc30f127d0ac66b8a0075e/1609309585814-424720Z7Y3QYF0IV71GH/02_intelli.JPG",
        desc: "The institution that invented direct trade coffee sourcing. The standard-bearer for traditional specialty coffee in LA.",
        reviews: [{ a: "Bon Appétit", t: "Intelligentsia invented the vocabulary for the entire specialty coffee industry." }, { a: "Regular", t: "The best traditional espresso in Silver Lake." }]
      },
      {
        name: "Canyon Coffee", hood: "Echo Park", rating: 4.8,
        tags: ["Date Spot", "Ambiance", "Best Latte"],
        hours: "Daily 7am–5pm", price: "$$", wifi: "Limited", seats: "Cozy", openNow: true, stamps: 423, isHiddenGem: true,
        photo: "https://s3-media0.fl.yelpcdn.com/bphoto/cI3Lx-irhIhCOF-NBURECA/348s.jpg",
        desc: "After years supplying beans to LA's best cafés, Canyon Coffee opened in Echo Park as a love letter to slow mornings.",
        reviews: [{ a: "Eater LA", t: "Canyon Coffee is what every neighborhood deserves." }, { a: "Regular", t: "Best date spot for coffee in all of LA." }]
      },
      {
        name: "Kindness & Mischief", hood: "Highland Park", rating: 4.7,
        tags: ["Experience", "Work Spot", "Matcha"],
        hours: "Mon–Fri 7am–5pm, Wknd 8am–5pm", price: "$$", wifi: "Yes", seats: "Plenty", openNow: true, stamps: 378, isHiddenGem: true,
        photo: "https://sprudge.com/wp-content/uploads/2016/06/Sprudge-KindnessAndMischief-TatianaErnst-KandM-Interior.jpg",
        desc: "Community-centered specialty shop with a turquoise facade. The rotating guest roaster program makes every visit a discovery.",
  ...
  "New York": {
    ...
    shops: [
      {
        name: "Arcane Estate Coffee", hood: "West Village", rating: 4.9,
        tags: ["Experience", "Traditional", "Date Spot"],
        hours: "Mon–Fri 8am–5pm, Wknd 9am–5pm", price: "$$$", wifi: "Limited", seats: "Cozy", openNow: true, stamps: 1456, isHiddenGem: false,
        photo: "https://media.timeout.com/images/106375451/750/422/image.jpg",
        desc: "Ranked #12 on the World's 100 Best Coffee Shops list in 2026. A moody West Village hideaway devoted to Panamanian single-origin coffee.",
        reviews: [{ a: "Timeout New York, 2026", t: "Arcane's devotion to Panama's terroir stands out as something genuinely world-class." }, { a: "Regular", t: "The most intentional cup of coffee I have ever had." }]
      },
      {
        name: "Sey Coffee", hood: "Bushwick, Brooklyn", rating: 4.9,
        tags: ["Best Latte", "Traditional", "Work Spot"],
        hours: "Mon–Fri 7am–5pm, Wknd 8am–5pm", price: "$$", wifi: "Yes", seats: "Plenty", openNow: true, stamps: 1123, isHiddenGem: false,
        photo: "https://sprudge.com/wp-content/uploads/2017/08/Sey_Coffee_Bushwick_Liz_Clayton-3-1104x780.jpg",
        desc: "Consistently ranked the finest specialty roaster in NYC. Light roasts so delicate you taste florals you didn't know existed in coffee.",
        reviews: [{ a: "My Coffee Explorer 2026", t: "Light roast masters. The Saturday line is worth every minute." }, { a: "Regular", t: "The best coffee in New York City, full stop." }]
      },
      {
        name: "Devoción", hood: "Williamsburg, Brooklyn", rating: 4.8,
        tags: ["Ambiance", "Best Latte", "Work Spot"],
        hours: "Daily 8am–6pm", price: "$$", wifi: "Yes", seats: "Plenty", openNow: true, stamps: 867, isHiddenGem: false,
        photo: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/08/4e/9d/c5/the-spacious-interior.jpg?w=900&h=500&s=1",
        desc: "A Colombian roaster with a breathtaking Williamsburg space and a living plant wall. Beans arrive within 10 days of harvest.",
        reviews: [{ a: "Drips of God", t: "The latte is exceptional and the farm-to-cup story is unmatched." }, { a: "Regular", t: "You can taste how fresh the beans are." }]
      },
      {
        name: "Maru Coffee", hood: "Williamsburg, Brooklyn", rating: 4.8,
        tags: ["Traditional", "Cappuccino", "Matcha"],
        hours: "Daily 7:30am–5pm", price: "$$", wifi: "Limited", seats: "Moderate", openNow: true, isNew: true, stamps: 634, isHiddenGem: false,
        photo: "https://www.marucoffee.com/cdn/shop/files/Maru_Coffee_Williamsburg_Brooklyn_4_1000x.jpg?v=1759875658",
        desc: "The cult LA favorite brought its Japanese-influenced precision to Williamsburg in late 2025. Beans never older than 3 days.",
        reviews: [{ a: "NYC-MAP.COM, 2026", t: "Coffee here isn't for work — it's for slowing down and savoring the moment." }, { a: "Regular", t: "Having Maru in Williamsburg feels like a gift to New York." }]
      },
      {
        name: "% Arabica — Dumbo", hood: "Dumbo, Brooklyn", rating: 4.8,
        tags: ["Experience", "Ambiance", "Matcha"],
        hours: "Daily 7:30am–6pm", price: "$$", wifi: "Limited", seats: "Moderate", openNow: false, isNew: true, stamps: 445, isHiddenGem: false,
        photo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMfWpxCHeqn_UH_IkjkG3MC6dFbCxAQvuqkw&s",
        desc: "The Kyoto roaster's Brooklyn flagship steps from the Brooklyn Bridge. The Spanish latte, matcha, and pour overs are all exceptional.",
        reviews: [{ a: "The Infatuation", t: "The baristas make a perfect cup every time." }, { a: "Regular", t: "Beautiful spot with the Brooklyn Bridge view." }]
      },
      {
        name: "Fast Times at Buck Mason", hood: "SoHo, Manhattan", rating: 4.7,
        tags: ["Experience", "Ambiance", "Date Spot"],
        hours: "Mon–Sat 8am–8pm, Sun 8am–7pm", price: "$$", wifi: "Yes", seats: "Plenty", openNow: true, isNew: true, stamps: 523, isHiddenGem: false,
        photo: "https://www.fasttimescoffee.com/cdn/shop/files/FastTimesSoHo.jpg?v=1753485485&width=900",
        desc: "A specialty coffee bar inside Buck Mason's SoHo flagship — 1,000 curated vintage books, candles, incense, vinyl.",
        reviews: [{ a: "TikTok visitor", t: "Ambiance 10/10. Candles, incense, great vinyl. Perfect solo creative session." }, { a: "Regular", t: "The coziest secret in SoHo. The brown sugar latte is exceptional." }]
      },
      {
        name: "787 Coffee", hood: "SoHo, Manhattan", rating: 4.7,
        tags: ["Traditional", "Experience", "Best Latte"],
        hours: "Daily 7am–8pm", price: "$$", wifi: "Yes", seats: "Moderate", openNow: true, stamps: 412, isHiddenGem: true,
        photo: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2e/80/9e/10/caption.jpg?w=900&h=500&s=1",
        desc: "The only NYC coffee shop that owns its own farm — Hacienda Iluminada in Puerto Rico. The Coquito Latte has a cult following.",
        reviews: [{ a: "787 Coffee", t: "We source from farms we trust — including our own farm in Puerto Rico." }, { a: "Regular", t: "The Coquito Latte is one of the best things I have ever had." }]
      },
      {
        name: "Café Integral", hood: "Nolita, Manhattan", rating: 4.9,
        tags: ["Cappuccino", "Traditional", "Best Latte"],
        hours: "Mon–Fri 7am–5pm, Wknd 8am–5pm", price: "$$$", wifi: "Limited", seats: "Cozy", openNow: true, stamps: 789, isHiddenGem: false,
        photo: "https://images.squarespace-cdn.com/content/v1/50ce0513e4b0c301a8234314/1473865808815-30VGNVGYLKI4A9DLXGJW/Screen+Shot+2016-09-14+at+10.08.22+AM.jpg?format=750w",
        desc: "A Nicaraguan-focused specialty roaster in a beautifully spare Nolita space where every cappuccino is a technical masterpiece.",
        reviews: [{ a: "New York magazine", t: "Integral proves that NYC can do specialty coffee as well as anywhere in the world." }, { a: "Regular", t: "The most precise, intentional cappuccino I have ever had." }]
      },
      {
        name: "Rhythm Zero", hood: "West Village, Manhattan", rating: 4.7,
        tags: ["Experience", "Ambiance", "Date Spot"],
        hours: "Mon–Fri 7am–4pm, Wknd 8am–4pm", price: "$$", wifi: "Check in store", seats: "Limited", openNow: true, isNew: false, stamps: 287, isHiddenGem: true,
        photo: "https://whereyoueat.com/r_gallery_images/rgallery-26776/Pic1.jpg",
        desc: "A creative multidisciplinary hub born in Greenpoint in 2022 — part specialty coffee bar, part gallery, part curated retail. One of NYC's most intentional third-wave coffee experiences, built in collaboration with artists, designers and brands.",
        reviews: [{ a: "Rhythm Zero", t: "From sourcing the finest coffee beans to curating exhibitions that spoke to the soul — every step required a leap of faith." }, { a: "Regular", t: "Came for the coffee, stayed for the whole vibe. Nothing else like it in the city." }]
      },
    ]
  }
};
...
const HERO_COLORS = {
  'Harun Coffee': '#1A0A00',
  'Arcane Estate Coffee': '#040108',
  'Sightglass Coffee': '#161622',
  'Sey Coffee': '#1A1A1A',
  'Devoción': '#051008',
  'Go Get Em Tiger': '#180700',
  'Linea Caffe': '#1A0A03',
  'Maru Coffee': '#080808',
  'Canyon Coffee': '#180D04',
  'Tadaima': '#0A1A0A',
  'Q Specialty Coffee': '#0A0A14',
  'Fast Times at Buck Mason': '#0A0806',
  'Café Integral': '#0A0A0A',
  '787 Coffee': '#0A0614',
  'Rhythm Zero': '#0A0A0E',
  'default': '#1A0F07',
};
...
const BADGES = [
  { id: 'first_stamp', emoji: '☕', title: 'First Sip', desc: 'Stamped your first shop', condition: (stamps) => Object.keys(stamps).length >= 1 },
  { id: 'three_stamps', emoji: '🎯', title: 'On a Roll', desc: 'Stamped 3 shops', condition: (stamps) => Object.keys(stamps).length >= 3 },
  { id: 'five_stamps', emoji: '🔥', title: 'Coffee Obsessed', desc: 'Stamped 5 shops', condition: (stamps) => Object.keys(stamps).length >= 5 },
  { id: 'ten_stamps', emoji: '💯', title: 'Double Digits', desc: 'Stamped 10 shops', condition: (stamps) => Object.keys(stamps).length >= 10 },
  { id: 'two_cities', emoji: '✈️', title: 'City Hopper', desc: 'Stamped shops in 2 cities', condition: (stamps) => new Set(Object.values(stamps).map(s => s.city)).size >= 2 },
  { id: 'three_cities', emoji: '🌎', title: 'Coast to Coast', desc: 'Stamped shops in all 3 cities', condition: (stamps) => new Set(Object.values(stamps).map(s => s.city)).size >= 3 },
  { id: 'matcha_lover', emoji: '🍵', title: 'Matcha Lover', desc: 'Stamped a Matcha shop', condition: (stamps) => Object.values(stamps).some(s => s.shop.tags?.includes('Matcha')) },
  { id: 'night_owl', emoji: '🦉', title: 'Night Owl', desc: 'Stamped Harun Coffee', condition: (stamps) => Object.keys(stamps).some(k => k.includes('Harun Coffee')) },
  { id: 'world_class', emoji: '🏆', title: 'World Class', desc: 'Stamped a top-ranked shop', condition: (stamps) => Object.keys(stamps).some(k => k.includes('Arcane Estate Coffee')) },
  { id: 'hidden_gem', emoji: '💎', title: 'Gem Hunter', desc: 'Stamped a hidden gem', condition: (stamps) => Object.values(stamps).some(s => s.shop.isHiddenGem) },
];
    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1, backgroundColor: '#fff' }}>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        ...
        <View style={{ padding: 22 }}>
          <TouchableOpacity style={styles.socialBtn}><Text style={styles.socialBtnIcon}>🍎</Text><Text style={styles.socialBtnText}>Continue with Apple</Text></TouchableOpacity>
          <TouchableOpacity style={styles.socialBtn}><Text style={styles.socialBtnIcon}>G</Text><Text style={styles.socialBtnText}>Continue with Google</Text></TouchableOpacity>
          ...
          <TouchableOpacity style={[styles.authBtn, (!email || !password) && { opacity: 0.4 }]} onPress={() => { if (email && password) onSuccess({ name: name || email.split('@')[0], email }); }} disabled={!email || !password}>
          ...
          <TouchableOpacity activeOpacity={1} onPress={() => {}}>
            <View style={styles.modalCard}>
              {!submitted ? (<>
                ...
                <Text style={styles.modalSub}>{city} has been added to our list. We'll let you know when it's live.</Text>
...
function HomeScreen({ onCityPress, onShopPress, onCategoryPress, user, saved, onToggleSave }) {
...
export default function App() {
  ...
  if (screen === 'auth') return <AuthScreen mode={authMode} onSuccess={(u) => { setUser(u); setScreen('main'); }} onBack={() => setScreen('onboarding')} />;
  ...
  const handleToggleStamp = (c, name) => {
    const key = c + '||' + name;
    const shop = SHOPS[c]?.shops.find(s => s.name === name);
    if (!shop) return;
    setStamps(prev => { const next = { ...prev }; if (next[key]) { delete next[key]; } else { next[key] = { shop, city: c, country: SHOPS[c].country, flag: SHOPS[c].flag, date: new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }) }; } return next; });
  };
  const handleToggleSave = (c, name) => {
    const key = c + '||' + name;
    const shop = SHOPS[c]?.shops.find(s => s.name === name);
    if (!shop) return;
    setSaved(prev => { const next = { ...prev }; if (next[key]) { delete next[key]; } else { next[key] = { shop, city: c }; } return next; });
  };
  ...
  const renderContent = () => {
    ...
    if (tab === 'profile') return <ProfileScreen user={user} stamps={stamps} onSignOut={() => { setUser(null); setStamps({}); setSaved({}); setVisitedShops({}); setScreen('onboarding'); }} />;
...
const styles = StyleSheet.create({
  ...
  socialBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, backgroundColor: '#F8F8F8', borderRadius: 14, height: 52, marginBottom: 12, borderWidth: 1, borderColor: '#F0F0F0' },
  socialBtnIcon: { fontSize: 18, fontWeight: '700', color: '#333', width: 22, textAlign: 'center' },
  socialBtnText: { fontSize: 15, fontWeight: '500', color: '#333' },
